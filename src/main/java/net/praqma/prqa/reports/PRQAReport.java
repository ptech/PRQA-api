...
public abstract class PRQAReport<T extends PRQAStatus> implements Serializable {
    ...
    public PRQAReport(QAR qar) {
    	logger.finest(String.format("Constructor called for class PRQAReport(QAR qar)"));
    ...
    public QAR getQar() {
    	...
    	logger.finest(String.format("Returning value: %s", this.qar));
    ...
    public void executeQAR() throws PrqaException {
		...
		logger.finest(String.format("Attempting to execute qar..."));
		try {
