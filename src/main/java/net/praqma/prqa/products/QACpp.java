...
public class QACpp extends PRQA {
    ...
    public QACpp(String command) {
    	logger.log(Level.FINEST, "Constructor called for class QACpp(String command)");
    	logger.log(Level.FINEST, "Input parameter command type: {0}; value: {1}", new Object[]{command.getClass(), command});
    	
        this.command = command;
        
        logger.log(Level.FINEST, "Ending execution of constructor - QACpp(String command)");
    }

    public QACpp(String commandBase, String command) {
    	logger.log(Level.FINEST, "Constructor called for class QACpp(String commandBase, String command)");
        ...
        logger.log(Level.FINEST, "Ending execution of constructor - QACpp(String commandBase, String command)");
    }
